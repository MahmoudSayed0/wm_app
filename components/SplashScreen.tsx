...
const PATH_LENGTH = 1500; // Approximate path length
    ...
    <View style={styles.container}>
      <Animated.View style={[styles.logoContainer, animatedContainerStyle]}>
        <Svg
          ...
          height={(SCREEN_WIDTH * 0.6 * 56) / 210}
          viewBox="0 0 210 56"
        >
